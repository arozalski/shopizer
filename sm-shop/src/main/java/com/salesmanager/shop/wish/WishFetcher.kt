...
abstract class WishFetcher {

    abstract val endpoint: String

    protected fun fetch(urlParameters: List<BasicNameValuePair>): String = HttpPost().apply {
    ...
    companion object {
        private const val BASE_URL = "https://www.wish.com/api/"
